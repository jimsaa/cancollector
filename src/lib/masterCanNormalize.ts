...
export function normalizeMasterCan(raw: RawMasterCan): MasterCan {
  ...
  const base = {
    ...
    external_product_id: raw.external_product_id?.trim() || null,
    corrected_by: raw.corrected_by ?? null,
    ...
    collection_set: raw.collection_set ?? null,
    base_product_key: raw.base_product_key ?? null,
    variant_country: raw.variant_country ?? null,
    variant_region: raw.variant_region ?? null,
    language_code: raw.language_code ?? null,
    release_date: raw.release_date ?? null,
    discontinued_date: raw.discontinued_date ?? null,
    catalog_date: raw.catalog_date ?? null,
    collector_summary: raw.collector_summary ?? null,
